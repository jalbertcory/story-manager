...
async def get_book_catalog(
    ...
    audiobook: Optional[Literal["available", "none", "playable", "unplayable"]] = None,
    genre: Optional[str] = None,
    sort_by: Literal["title", "author", "word_count", "updated_at", "audiobook_enabled", "series_index"] = "title",
