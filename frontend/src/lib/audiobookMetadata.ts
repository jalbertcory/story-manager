...
export function audiobookFilenameMetadata(
...
export function audiobookCueMetadata(text: string) {
  const metadata: Partial<{ title: string; author: string }> = {};
...
export async function suggestAudiobookMetadata(files: readonly File[]) {
