...
function getEffectiveGenreTags(book: CatalogBook) {
...
export function AudiobookBadge({ book }: { book: CatalogBook }) {
...
export function BookCard({
  ...
  const handleCoverError = (e: SyntheticEvent<HTMLImageElement>) => {
    e.currentTarget.onerror = null;
    e.currentTarget.src = NO_COVER_SVG;
  };
  ...
  return (
    ...
    >
      ...
      <div className="book-info">
        <h3
          title={
            isPending || isError ? (book.source_url ?? undefined) : book.title
          }
        >
          {isPending
            ? "Downloading…"
