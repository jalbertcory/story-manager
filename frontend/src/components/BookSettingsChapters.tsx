...
import type { getBookChapters } from "../api/books";
type Chapter = Awaited<ReturnType<typeof getBookChapters>>[number];
...
function BookSettingsChapters({
  ...
  book: Book;
  chapters: Chapter[];
  cleanedChapters: Chapter[];
  chaptersLoading: boolean;
  cleanedChaptersLoading: boolean;
  chaptersExpanded: boolean;
  setChaptersExpanded: Dispatch<SetStateAction<boolean>>;
  chapterPreviewMode: string;
  setChapterPreviewMode: (mode: string) => void;
  chapterSearch: string;
  setChapterSearch: (search: string) => void;
  removedChapters: string[];
  toggleChapter: (filename: string) => void;
  previewedChapter: string | null;
  toggleChapterPreview: (filename: string) => void;
}) {
